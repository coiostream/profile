...
Updated at 2023-24-05

IO Stream ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by "IO Apps".

This "IO Apps" is cosidered and defined as Apps Series which are developed by IO Stream.

"IO Apps" is the general name of 1 of IO Stream apps:

🔒 All processing of "IO Apps" is performed locally on your computer where your files remain safe and private.

This Privacy Policy applies to our application named "IO Apps", and its associated subdomains (collectively, our "Service").
...
*   Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to IO Stream Company Limited, 30 Trinh Dinh Thao, Hoa Thanh, Tan Phu, HCMC that is responsible for your information under this Privacy Policy.
*   Country: where "IO Apps" or the owners/founders of "IO Apps" are based, in this case is Vietnam.
*   Customer: refers to the company, organization or person that signs up to use the "IO Apps" to manage the relationships with your consumers or service users.
*   Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit "IO Apps" and use the services.
*   IP address: Every device connected to the Internet is assigned a number known as an Internet protocol (IP) address. These numbers are usually assigned in geographic blocks. An IP address can often be used to identify the location from which a device is connecting to the Internet.
*   Personnel: refers to those individuals who are employed by IO Stream or are under contract to perform a service on behalf of one of the parties.
*   Personal Data: any information that directly, indirectly, or in connection with other information — including a personal identification number — allows for the identification or identifiability of a natural person.
*   Service: refers to the service provided by "IO Apps" as described in the relative terms (if available) and on this platform.
*   Third-party service: refers to advertisers, contest sponsors, promotional and marketing partners, and others who provide our content or whose products or services we think may interest you.
*   Website: "IO Apps"'s site, which can be accessed via this URL: http://www.iostream.vn
*   You: a person or entity that is registered with "IO Apps" to use the Services.
...
The laws of Vietnam, excluding its conflicts of law rules, shall govern this Agreement and your use of our service. Your use of our service may also be subject to other local, state, national, or international laws.
...
This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by "IO Apps". We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website's own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.
...
*   *   Via Email: [developer@iotream.vn](mailto:developer@stdio.vn)
    *   Via this Link: [https://www.iostream.vn/contact](/contact)